...
2. **Use GitHub's [private vulnerability reporting](https://github.com/lukisch/n8n-manager-mcp/security/advisories/new)**
3. Include: description, steps to reproduce, potential impact

### How to Report

1. Go to: https://github.com/lukisch/n8n-manager-mcp/security/advisories/new
